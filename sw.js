...
const CACHE = 'ipas-v67';
const SHELL = ['./', 'index.html', 'build.html', 'app.js', 'core.js', 'manifest.json', 'favicon.svg', 'questions.json', 'concepts.json', 'knowledge.json', 'exam-dates.json', 'icon-192.png', 'icon-512.png'];
